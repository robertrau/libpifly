...
There is a small breakout board for the A/D converter analog input connector. This adapts the 0.050” pitch connector to some 0.10” connectors and also provides a voltage reference for additional thermistors. 
